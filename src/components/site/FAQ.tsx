  ...
  return (
    <section className="py-24 md:py-32">
      <div className="container-x grid gap-12 lg:grid-cols-[1fr_1.4fr]">
        <div>
          <span className="text-xs uppercase tracking-[0.2em] text-lime">FAQ</span>
          ...
          {faqs.map((f, i) => {
            ...
            return (
              <div key={f.q}>
                ...
                >
                  <span className="font-display text-lg font-semibold tracking-tight md:text-xl">{f.q}</span>
                  <motion.span animate={{ rotate: isOpen ? 45 : 0 }} className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-white/15">
