...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "John is a premium product studio building software, web and mobile apps for ambitious brands and startups." },
      { property: "og:title", content: "John — Premium Product Studio" },
      { property: "og:description", content: "We design and engineer software, web and mobile experiences that scale." },
